...
if(isset($_POST['submit'])){
  ...
  $sql = mysqli_query($con,"INSERT INTO reviews(text,name) VALUES ('$text','$name')");
}
...
<div id="body-wrapper" class="animsition">
    ...
    <div id="content">
        ...
        <div class="page-title page-title-lg bg-dark dark">
            ...
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    ...
                    <h5 class="text-muted mb-0">Check out our reviews</h5>
                </div>
            </div>
        </div>
                ...
                <div class="row mb-5">
                    <div class="col-xl-8 offset-xl-2">
                        ...
                        <blockquote class="blockquote blockquote-lg lightanimated" data-animation="fadeIn">
                            <div class="blockquote-content">
                                <div class="rate rate-sm mb-3"><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star"></i></div>
                                <p>My food got here very quickly and it was tasty.</p>
                            </div>
                            <footer>
                                <img src="imgs/idpic.jpg" alt="">
                                <span class="name">Kate Nyamekeye<span class="text-muted">, Google</span></span>
                            </footer>
                        </blockquote>
                        <!-- Blockquote -->
                        <blockquote class="blockquote blockquote-lganimated" data-animation="fadeIn">
                            ...
                            <footer>
                                <img src="imgs/idpic.jpg" alt="">
                                <span class="name">Gwen Afua<span class="text-muted">, LinkedIn</span></span>
                            </footer>
                        </blockquote>
                        <!-- Blockquote -->
                        <blockquote class="blockquote blockquote-lg lightanimated" data-animation="fadeIn">
                            <div class="blockquote-content">
                                <div class="rate rate-sm mb-3"><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star"></i></div>
                                <p>So easy to order and pay!</p>
                            </div>
                            <footer>
                                <img src="imgs/idpic.jpg" alt="">
                                <span class="name">Portia Kwakye<span class="text-muted">, Google</span></span>
                            </footer>
                        </blockquote>
                        <!-- Blockquote -->
                        <blockquote class="blockquote blockquote-lganimated" data-animation="fadeIn">
                            ...
                            <footer>
                                <img src="imgs/idpic.jpg" alt="">
                                <span class="name">Japhet Cofie<span class="text-muted">, LinkedIn</span></span>
                            </footer>
                        </blockquote>
                        <!-- Blockquote -->
                        <blockquote class="blockquote blockquote-lg lightanimated" data-animation="fadeIn">
                            <div class="blockquote-content">
                                <div class="rate rate-sm mb-3"><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star"></i></div>
                                <p>My table reservation was very easy to get!</p>
                            </div>
                            <footer>
                                <img src="imgs/idpic.jpg" alt="">
                                <span class="name">Sena Aryee<span class="text-muted">, Google</span></span>
                            </footer>
                        </blockquote>
                        <!--Blockquote-->
                         <blockquote class="blockquote blockquote-lg lightanimated" data-animation="fadeIn">
                            <div class="blockquote-content">
                                <div class="rate rate-sm mb-3"><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star"></i></div>
                                <p>The interface is very user friendly.</p>
                            </div>
                            <footer>
                                <img src="imgs/idpic.jpg" alt="">
                                <span class="name">Danielle Anaga<span class="text-muted">, Google</span></span>
                            </footer>
                        </blockquote>
                        <!-- Blockquote -->
                        <blockquote class="blockquote blockquote-lg lightanimated" data-animation="fadeIn">
                            <div class="blockquote-content">
                                <div class="rate rate-sm mb-3"><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star active"></i><i class="fa fa-star"></i></div>
                                <p>Its very easy to navigate the app and very convenient!</p>
                            </div>
                            <footer>
                                <img src="imgs/idpic.jpg" alt="">
                                <span class="name">Erica Boakye<span class="text-muted">, Google</span></span>
                            </footer>
                        </blockquote>
                    </div>
                </div>
        ...
        <section class="section section-lg dark bg-dark">
            ...
            <div class="bg-image bg-parallax"><img src="imgs/pen.jpg" alt=""></div>
    ...
    <nav id="panel-mobile">
        <div class="module module-logo bg-dark dark">
            <a href="#">
                <img src="assets/img/PATO.png" alt="" width="800">
            </a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="#" method="post">
                    <div class="form-group">
                        <textarea cols="30" rows="6" name="text" class="form-control" placeholder="Write here your review..."></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="text-center">
                        <button name="submit" class="btn btn-primary"><span>Add review</span></button>
                    </div>
                </form>
            </div>
        </div>
