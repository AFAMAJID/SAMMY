            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 offset-lg-4">
                        ...
                        <h4 class="text-muted mb-0">Take A Pick From Our Delicious Catalog</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-9">
                        ...
                        <div id="Burgers" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image"><img src="imgs/burger.jpg" alt=""></div>
                            ...
                            <div class="menu-category-content">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            ...
                                            <span class="text-muted text-sm">Beef, cheese, tomato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>50.00</span></span>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Ham Burger</h6>
                                            <span class="text-muted text-sm">Ham, cheese, tomato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>50.00</span></span>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            ...
                                            <span class="text-muted text-sm">Chicken, cheese, tomato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>50.00</span></span>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Vegan Burger</h6>
                                            <span class="text-muted text-sm">Tofu, tomato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>70.00</span></span>
                        ...
                        <div id="Pasta" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image"><img src="imgs/pasta.jpg" alt=""></div>
                            ...
                            <div class="menu-category-content">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Spaghetti Bolgnese</h6>
                                            <span class="text-muted text-sm">Beef, cheese, tomato, onion, fries</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>90.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="1"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Seafood Pasta</h6>
                                            <span class="text-muted text-sm">Coconut curry cream / Basil</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>175.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="2"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">PENNE NAPOLI (VEGAN) </h6>
                                            <span class="text-muted text-sm">Penne, onion, garlic, basil, tomato sauce, oregano</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price>90.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="3"><span>Add to cart</span></button>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Mac & Cheese</h6>
                                            <span class="text-muted text-sm">Pasta in cheese sauce</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price>70.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="4"><span>Add to cart</span></button>
                        ...
                        <div id="Pizza" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image"><img src="imgs/pizza.jpg" alt=""></div>
                            ...
                            <div class="menu-category-content">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Beef Pizza</h6>
                                            <span class="text-muted text-sm">Beef, cheese, tomato sauce</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>80.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="1"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Veggie Lovers</h6>
                                            <span class="text-muted text-sm">Mixed vegetables, cheese, tomato sauce</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>80.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="2"><span>Add to cart</span></button>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Chicken Pizza</h6>
                                            <span class="text-muted text-sm">Chicken, cheese, tomato sauce </span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>80.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="3"><span>Add to cart</span></button>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            ...
                                            <span class="text-muted text-sm">Pepperoni, cheese, tomato sauce </span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>80.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="4"><span>Add to cart</span></button>
                        ...
                        <!-- Menu Category / Rice -->
                        <div id="Rice" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image"><img src="imgs/rice.jpg" alt=""></div>
                            ...
                            <div class="menu-category-content">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Jollof</h6>
                                            <span class="text-muted text-sm">Shrimp / Fried beef / Veggie jollof</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price> 70.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="1"><span>Add to cart</span></button>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Garlic Coconut Rice</h6>
                                            <span class="text-muted text-sm"> </span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>60.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="2"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Ginger Rice Pilaf</h6>
                                            <span class="text-muted text-sm"> </span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>65.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="3"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            ...
                                            <span class="text-muted text-sm">Shrimp / Fried beef / Veggie </span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>70.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="4"><span>Add to cart</span></button>
                        ...
                        <div id="Desserts" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image"><img src="imgs/dessert.jpg" alt=""></div>
                            ...
                            <div class="menu-category-content">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Passion Mousse</h6>
                                            <span class="text-muted text-sm">Citrus / Berries / Merengue Chips / Cake Croutons</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price> 70.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="1"><span>Add to cart</span></button>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Cookie Plate</h6>
                                            <span class="text-muted text-sm">Oatmeal / Cranberry / Chewy Chocolate Chips / Strawberry / Shortbread</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price> 40.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="2"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Ice Cream Trio</h6>
                                            <span class="text-muted text-sm">Vanilla Bean / Chocolate / Butter Scotch / Walnut</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price> 55.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="3"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Fresh Fruit Plate</h6>
                                            <span class="text-muted text-sm">Seasonal Fruit</span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price> 40.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="4"><span>Add to cart</span></button>
                        ...
                        <div id="Drinks" class="menu-category">
                            <div class="menu-category-title">
                                <div class="bg-image"><img src="imgs/drink.jpg" alt=""></div>
                            ...
                            <div class="menu-category-content">
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS <span data-product-base-price>30.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="2"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu-item menu-list-item">
                                    <div class="row align-items-center">
                                        <div class="col-sm-6 mb-2 mb-sm-0">
                                            <h6 class="mb-0">Red wine</h6>
                                            <span class="text-muted text-sm"> </span>
                                        </div>
                                        <div class="col-sm-6 text-sm-right">
                                            <span class="text-md mr-4"><span class="text-muted">from</span> GHS<span data-product-base-price>100.00</span></span>
                                            <button class="btn btn-outline-secondary btn-sm" data-action="open-cart-modal" data-id="3"><span>Add to cart</span></button>
                                        </div>
                                    </div>
                                </div>
